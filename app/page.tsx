...
export default function Page() {
    ...
    <main className="flex min-h-screen flex-col p-6">
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          ...
          >
            {/*<span>Log in</span> <ArrowRightIcon className="w-96 md:w-20" />*/}
            <ArrowRightIcon className="w-5 md:w-20 lg:w-96" />
  ...
  <tbody>
    ...
    <tr>
      <td className="border border-gray-400 px-4 py-2">Row 4</td>
      <td className="border border-gray-400 px-4 py-2">Data</td>
      <td className="border border-gray-400 px-4 py-2">Info</td>
    </tr>
  </tbody>
